...
interface ProductsRepository {
    ...
    suspend fun getTags(
        source: Source = Source.REMOTE_IF_EXPIRED(TimeUnit.DAYS.toMillis(1))
    ): Either<Failure, List<Tag>>

    suspend fun getMainProductsByTagId(
        tagId: String,
        source: Source = Source.REMOTE_IF_EXPIRED(TimeUnit.MINUTES.toMillis(10))
    ...
    suspend fun getVariationsByMainId(
        mainId: String,
        source: Source = Source.REMOTE_IF_EXPIRED(TimeUnit.MINUTES.toMillis(15))
