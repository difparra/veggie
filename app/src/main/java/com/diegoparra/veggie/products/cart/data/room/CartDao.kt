...
abstract class CartDao {
    ...
    protected abstract fun _getQuantityItem(
        mainId: String,
        varId: String,
        detail: String
    ): Flow<Int?>
    ...
    fun getVariations(mainId: String, varId: String) =
        _getVariations(mainId, varId).distinctUntilChanged()
    ...
    fun deleteItem(prodIdRoom: ProdIdRoom) =
        _deleteItem(prodIdRoom.mainId, prodIdRoom.varId, prodIdRoom.detail)

    @Query("Update Cart set quantity = :newQuantity where mainId = :mainId and varId = :varId and detail = :detail")
    protected abstract fun _updateQuantityItem(
        mainId: String,
        varId: String,
        detail: String,
        newQuantity: Int
    ...
    fun updateQuantityItem(prodIdRoom: ProdIdRoom, newQuantity: Int) =
        _updateQuantityItem(prodIdRoom.mainId, prodIdRoom.varId, prodIdRoom.detail, newQuantity)
    ...
    fun getItem(prodIdRoom: ProdIdRoom) =
        _getItem(prodIdRoom.mainId, prodIdRoom.varId, prodIdRoom.detail)

    @Query("Select quantity from Cart where mainId = :mainId and varId = :varId and detail = :detail")
    protected abstract fun _getCurrentQuantityItem(
        mainId: String,
        varId: String,
        detail: String
    ): Int?

    fun getCurrentQuantityItem(prodIdRoom: ProdIdRoom) =
        _getCurrentQuantityItem(prodIdRoom.mainId, prodIdRoom.varId, prodIdRoom.detail)
