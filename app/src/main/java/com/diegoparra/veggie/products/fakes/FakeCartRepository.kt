...
import com.diegoparra.veggie.products.fakes.UtilsFakesCart.getIdTest
...
class FakeCartRepository(
    _cartItems: List<CartItem> = listOf(
        CartItem(
            productId = FakeProductsDatabase.banano_lbMV.getIdTest(detail = FakeDetail.Maduro.detail),
            quantity = 2
        ),
        CartItem(
            productId = FakeProductsDatabase.banano_lbMV.getIdTest(detail = FakeDetail.Verde.detail),
            quantity = 5
        ),
