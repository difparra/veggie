...
import com.diegoparra.veggie.auth.databinding.FragmentForgotPasswordBinding
            ...
            val email = when (it) {
                ...
                is Resource.Error -> {
                    when (val failure = it.failure) {
                        is AuthFailure.WrongInput -> failure.input
                        is AuthFailure.WrongSignInMethod -> failure.email
                        else -> ""
                    }
                }
                is Resource.Loading -> ""
