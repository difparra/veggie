package com.diegoparra.veggie.user.auth.data

import android.net.Uri
import com.diegoparra.veggie.core.*
import com.diegoparra.veggie.products.IoDispatcher
import com.diegoparra.veggie.user.auth.data.firebase.CredentialToFirebaseAuthTransformations.getAuthCredential
import com.diegoparra.veggie.user.auth.data.AuthTransformations.isSignedIn
import com.diegoparra.veggie.user.auth.data.AuthTransformations.toProfile
import com.diegoparra.veggie.user.auth.data.firebase.AuthApi
import com.diegoparra.veggie.user.auth.data.prefs.AuthPrefs
