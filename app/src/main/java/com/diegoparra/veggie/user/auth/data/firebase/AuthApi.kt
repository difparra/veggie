package com.diegoparra.veggie.user.auth.data.firebase

import android.net.Uri
import com.diegoparra.veggie.core.*
import com.diegoparra.veggie.user.auth.data.firebase.FirebaseAuthExceptionsTransformations.toFailure
import com.diegoparra.veggie.user.auth.data.AuthTransformations.fromSignInMethod
        ...
        return try {
            ...
            if (message != null) {
                if (message.contains("invalid", ignoreCase = true)) {
                    Either.Left(Failure.PhoneAuthFailures.InvalidSmsCode)
                } else if (message.contains("expired", ignoreCase = true)) {
                    Either.Left(Failure.PhoneAuthFailures.ExpiredSmsCode)
                } else {
