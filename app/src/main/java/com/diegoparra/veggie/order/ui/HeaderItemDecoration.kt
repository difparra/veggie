...
/*
 * Copied from https://gist.github.com/filipkowicz/1a769001fae407b8813ab4387c42fcbd
 * Works fine, but take into account some details:
 * -> Will not consider paddingHorizontal in recycler view. Use marginHorizontal instead.
 * -> Will not work fine if header has margins. Use other item decorations to add spaces between items.
 * -> Will not work really fine with clipToPadding = false
 * -> Avoid backgrounds with alpha in header items.
 */
