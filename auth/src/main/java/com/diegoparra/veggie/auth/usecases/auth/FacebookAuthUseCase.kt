...
class FacebookAuthUseCase @Inject constructor(
    ...
    override suspend fun validate(params: Either<FacebookException, LoginResult>): Either<AuthFailure.ValidationFailures, Unit> {
        //  There are no previous validations to perform when signing in with Facebook
        return Either.Right(Unit)
    }

    override suspend fun authenticate(params: Either<FacebookException, LoginResult>): Either<AuthFailure, AuthResults> {
